...
public class JwtOperator {
    ...
    /*public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1Nzg4NDA0MDEsImV4cCI6MTU4MDA1MDAwMX0.TKgcjaCv-Z_sYy71vTZ4G0hl6ZkknQEYgE3bgVf-Mo8";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1Nzg4NDA0MDEsImV4cCI6MTU4MDA1MDAwMX0";
        // 测试5: 解密Payload
